## ⚠️ This project has been retired. Consider using @opensourceframework/next-mdx-remote or mdx-bundler or nextra.

<div align="center">
  <img src="https://user-images.githubusercontent.com/124599/109961945-0c061b00-7d04-11eb-9c19-17f33430b59f.jpg" />
  <h1>@opensourceframework/next-mdx</h1>
</div>

<p align="center">
  <a href="https://github.com/shadcn/@opensourceframework/next-mdx/actions/workflows/ci.yml"><img src="https://github.com/shadcn/@opensourceframework/next-mdx/actions/workflows/ci.yml/badge.svg" alt="Test"></a>
  <a href="https://github.com/shadcn/@opensourceframework/next-mdx/blob/master/LICENSE.md"><img src="https://img.shields.io/npm/l/@shadcn/gatsby-theme-phoenix.svg" alt="License"></a>
  <a href="https://github.com/shadcn/@opensourceframework/next-mdx/pulls"><img src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg" alt="PRs welcome!" /></a>
  <a href="https://twitter.com/shadcn"><img src="https://img.shields.io/badge/Follow-%40shadcn-1da1f2" alt="Follow @shadcn" /></a>
</p>

<p align="center">
  <strong>@opensourceframework/next-mdx</strong> provides a set of helper functions for fetching and rendering local MDX files. It handles <strong>relational data</strong>, supports <strong>custom components</strong>, <strong>TypeScript</strong> ready and is <strong>really fast</strong>.
</p>

<p align="center">
<strong>@opensourceframework/next-mdx</strong> is great for building mdx-powered pages, multi-user blogs, category pages..etc.
</p>

<div align="center">
  <img src="https://user-images.githubusercontent.com/124599/110736366-f2edf480-8244-11eb-9b43-f27f6f578f4c.jpg" alt="@opensourceframework/next-mdx-relational-data" />
</div>
...
https://@opensourceframework/next-mdx-example.vercel.app

### Attribution

- **Original Author**: Unknown
- **Original Repository**: https://github.com/shadcn/next-mdx
- **Original License**: MIT



Learn how @opensourceframework/next-mdx works by looking at examples.

1. Go to [example-page](examples/example-page)
2. Open `@opensourceframework/next-mdx.json` to see the sample configuration.
...
<details>
  <summary>@opensourceframework/next-mdx.json</summary>
...
<details>
  ...
  ```jsx
  import { useHydrate } from "@opensourceframework/next-mdx/client"
  import { getMdxNode, getMdxPaths } from "@opensourceframework/next-mdx/server"
...
npm i --save @opensourceframework/next-mdx

````

## Configuration

Create a `@opensourceframework/next-mdx.json` file at the root of your project with the following:
...
`@opensourceframework/next-mdx` exposes 6 main helper functions:
...
- `sourceName` is the unique ID defined in `@opensourceframework/next-mdx.json`

#### Example

```js
// pages/blog/[...slug].js
import { getMdxPaths } from "@opensourceframework/next-mdx/server"
...
```js
// pages/blog/[...slug].js
import { getNode } from "@opensourceframework/next-mdx/server"
...
```js
import { getAllNodes } from "@opensourceframework/next-mdx/server"
...
```js
// pages/blog/[...slug].js
import { getMdxNode } from "@opensourceframework/next-mdx/server"
...
```js
import { getAllMdxNodes } from "@opensourceframework/next-mdx/server"
...
When retrieving nodes with `getMdxNode` or `getAllMdxNodes`, `@opensourceframework/next-mdx` will automatically infer relational data from frontMatter keys.

### Convention

1. The frontMatter field name must be the same as the key defined in `@opensourceframework/next-mdx.json`
...
- [@opensourceframework/next-mdx-toc](/packages/@opensourceframework/next-mdx-toc): Add table of contents to MDX pages.
...
```ts
import { MdxNode } from "@opensourceframework/next-mdx/server"
...
Licensed under the [MIT license](https://github.com/shadcn/@opensourceframework/next-mdx/blob/master/LICENSE).
