 ...
 * @param  callback Callback receiving the error, if any, and the resulting salt
 */
export declare function genSalt(rounds: number, callback: Callback<string>): void;
 ...
 */
export declare function hashSync(password: string, salt?: number | string): string;
 ...
 */
export declare function hash(password: string, salt: number | string): Promise<string>;
 ...
 */
export declare function compare(password: string, hash: string): Promise<boolean>;
