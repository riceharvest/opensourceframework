...
# or
yarn add @opensourceframework/next-seo
# or
pnpm add @opensourceframework/next-seo
# or
bun add @opensourceframework/next-seo
```
...
<ArticleJsonLd
  ...
  url="https://example.com/news/@opensourceframework/next-seo-v7"
  datePublished="2024-01-01T08:00:00+08:00"
...
Next SEO now supports creating your own custom JSON-LD components using the same utilities and patterns as the built-in components. This allows you to implement any Schema.org type while maintaining the excellent developer experience of @opensourceframework/next-seo.
