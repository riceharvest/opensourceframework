  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <div className="prose lg:prose-xl">
        ...
        <p>
          This page demonstrates the all-in-one page pattern for movie carousels, where all movie
        ...
        <div className="space-y-8">
          <div id="a-star-is-born" className="border-b pb-6">
            ...
            <p>
              A musician helps a young singer find fame as age and alcoholism send his own career
          ...
          <div id="bohemian-rhapsody" className="border-b pb-6">
            ...
            <p>
              ...
              leading up to their famous performance at Live Aid.
            </p>
          </div>
          ...
          <div id="black-panther" className="border-b pb-6">
            ...
            <p>
              ...
              lead his people into a new future.
            </p>
          </div>
        </div>
      </div>
