  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <article className="prose lg:prose-xl">
        ...
        <ol>
          <li>
            <strong>Set up safety signals:</strong> Turn on your hazard lights and set out flares or
          ...
          <li>
            <strong>Secure the vehicle:</strong> Position wheel wedges in front of front tires (for
            rear flat) or behind rear tires (for front flat).
            <div className="text-sm text-gray-500 mt-1">
        ...
        <ol>
          <li>
            <strong>Position the jack:</strong> Place it underneath the car, next to the flat tire.
          </li>
          <li>
            <strong>Raise the vehicle:</strong> Lift until the flat tire is barely off the ground.
            <div className="text-sm text-gray-500 mt-1">
              💡 Tip: It doesn't need to be too high - just enough to clear the ground.
            </div>
          </li>
          <li>
            <strong>Remove hubcap:</strong> Take off the hubcap and loosen the lug nuts.
          </li>
          <li>
            <strong>Swap the tire:</strong> Remove the flat and mount the spare on the lug bolts.
          </li>
          <li>
        ...
        <ol>
          <li>
            <strong>Lower and tighten:</strong> Lower the jack and use the wrench to fully tighten
            lug nuts.
          </li>
          <li>
            <strong>Replace hubcap:</strong> Put the hubcap back on if your spare uses one.
          </li>
          <li>
            <strong>Store equipment:</strong> Put away the jack, wrench, and flat tire.
          </li>
        </ol>
        ...
        <div className="bg-gray-100 p-4 rounded-lg my-8">
          ...
          <p>
            Watch our 8-minute video tutorial to see a professional mechanic demonstrate the proper
            technique.
          </p>
        </div>
      </article>
