  ...
  return (
    <div className="container mx-auto p-8">
      <CarouselJsonLd
        ...
        items={[
          ...
          },
          {
            ...
            description: 'Moist and flavorful banana bread with a perfect texture',
            author: 'Grandma Rose',
            prepTime: 'PT15M',
            cookTime: 'PT60M',
            totalTime: 'PT75M',
      ...
      <div className="prose lg:prose-xl">
        <p>Explore our collection of delicious recipes that are perfect for any occasion.</p>
        ...
        <div className="grid gap-6 mt-6">
          <div className="border p-6 rounded-lg shadow">
            ...
            <h3 className="text-2xl font-semibold">Perfect Chocolate Chip Cookies</h3>
          ...
          <div className="border p-6 rounded-lg shadow">
            <div className="h-48 bg-gray-200 rounded mb-4"></div>
            <h3 className="text-2xl font-semibold">Homemade Pizza Margherita</h3>
            <p className="text-gray-600 mt-2">
