  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <div className="prose lg:prose-xl">
        <p>
          Explore our top-rated web development courses designed to take your skills to the next
          level.
        </p>
        ...
        <div className="grid gap-6 mt-6">
          <div className="border p-6 rounded-lg shadow">
            <h3 className="text-2xl font-semibold">Introduction to Web Development</h3>
            <p className="text-gray-600 mt-2">
              Learn the fundamentals of HTML, CSS, and JavaScript to build modern websites
            </p>
            <p className="text-sm text-gray-500 mt-2">Provider: Tech Academy Online</p>
            <a
          ...
          <div className="border p-6 rounded-lg shadow">
            ...
            <p className="text-gray-600 mt-2">
              Master React.js from basics to advanced concepts including hooks, context, and
              performance optimization
            </p>
            <p className="text-sm text-gray-500 mt-2">Provider: Code School Pro</p>
            <a
          ...
          <div className="border p-6 rounded-lg shadow">
            ...
            <p className="text-sm text-gray-500 mt-2">Provider: Developer Institute</p>
            <button className="bg-blue-600 text-white px-4 py-2 rounded mt-4">Coming Soon</button>
          </div>

          <div className="border p-6 rounded-lg shadow">
            <h3 className="text-2xl font-semibold">Full-Stack Development with Next.js</h3>
            <p className="text-gray-600 mt-2">
              Build production-ready full-stack applications with Next.js, TypeScript, and Tailwind
              CSS
            </p>
            <p className="text-sm text-gray-500 mt-2">Provider: Modern Web Academy</p>
            <a
