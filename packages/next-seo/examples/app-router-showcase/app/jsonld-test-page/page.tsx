...
import { JsonLdScript } from '@opensourceframework/next-seo'; // Or the correct path if not yet fully packaged
...
export default function JsonLdTestPage() {
  return (
    <div>
      ...
      <JsonLdScript data={testData} id="e2e-jsonld-script" scriptKey="e2e-test" />
    </div>
  );
}
