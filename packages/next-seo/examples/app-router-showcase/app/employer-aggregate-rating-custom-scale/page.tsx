  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Green Energy Corp - Employee Satisfaction Score</h1>

        <section className="mb-8">
          <div className="bg-green-50 p-8 rounded-xl mb-6">
            <h2 className="text-2xl font-semibold mb-4">Employee Satisfaction Index</h2>
            <div className="flex items-center gap-6">
              ...
              <div>
                <p className="text-gray-600">Percentage-based satisfaction score</p>
                <p className="text-sm text-gray-500 mt-1">Based on 432 employee reviews</p>
                <p className="text-xs text-gray-400 mt-2">Scale: 0% (worst) to 100% (best)</p>
              </div>
            </div>
          </div>

          <h2 className="text-2xl font-semibold mb-4">About Our Rating System</h2>
          <p className="text-gray-700 mb-4">
            At Green Energy Corp, we use a percentage-based rating system where employees rate their
            overall satisfaction from 0% to 100%. This intuitive scale allows for more nuanced
            feedback compared to traditional star ratings.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">Rating Breakdown by Category</h2>
        ...
        <section className="mb-8">
          ...
          <div className="bg-gradient-to-r from-green-100 to-blue-100 p-6 rounded-lg">
            <p className="text-gray-700 mb-4">
              Green Energy Corp is committed to sustainable practices not just in our products, but
              also in how we treat our employees. Our percentage-based rating system reflects our
        ...
        <section>
          ...
          <p className="text-gray-700 mb-4">
            Be part of a company that's making a real difference in the fight against climate change
