  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <article className="prose lg:prose-xl">
        ...
        <p className="text-gray-600">By La Cucina Italiana | January 25, 2024</p>
        ...
        <p>
          Tiramisu, which means "pick me up" in Italian, is one of Italy's most beloved desserts.
          This authentic recipe creates the perfect balance of coffee-soaked ladyfingers, creamy
          mascarpone, and rich cocoa.
        </p>
        ...
        <ol>
          <li>
            Whisk egg yolks and sugar in a double boiler over simmering water until thick and pale
          </li>
        ...
        <ol>
          ...
          <li>Quickly dip each ladyfinger into coffee mixture and arrange in dish</li>
        ...
        <div className="bg-blue-50 p-6 rounded-lg my-8">
          ...
          <p className="text-sm text-gray-600 mb-4">Per serving (1/8 of dish)</p>
