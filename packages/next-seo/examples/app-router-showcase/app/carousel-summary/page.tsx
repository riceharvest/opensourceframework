  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <div className="prose lg:prose-xl">
        <p>
          This page demonstrates the summary page pattern for carousels, where we only provide URLs
          to detail pages.
        </p>
        ...
        <div className="grid gap-4 mt-6">
          <div className="border p-4 rounded">
            ...
            <a href="https://example.com/recipe/chocolate-cookies" className="text-blue-600">
              View Recipe →
            </a>
          </div>
          ...
          <div className="border p-4 rounded">
            ...
            <a href="https://example.com/recipe/banana-bread" className="text-blue-600">
              View Recipe →
            </a>
          </div>
          ...
          <div className="border p-4 rounded">
            ...
            <a href="https://example.com/recipe/apple-pie" className="text-blue-600">
              View Recipe →
            </a>
          </div>
          ...
          <div className="border p-4 rounded">
            ...
            <a href="https://example.com/recipe/pancakes" className="text-blue-600">
              View Recipe →
            </a>
          </div>
          ...
          <div className="border p-4 rounded">
            ...
            <a href="https://example.com/recipe/brownies" className="text-blue-600">
              View Recipe →
            </a>
          </div>
        </div>
