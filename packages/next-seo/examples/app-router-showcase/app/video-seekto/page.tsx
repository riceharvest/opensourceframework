  ...
  return (
    <div className="container mx-auto p-8">
      <VideoJsonLd
        ...
        potentialAction={{
          target: 'https://example.com/videos/kitchen-tips?t={seek_to_second_number}',
      ...
      <main className="prose lg:prose-xl mx-auto">
        ...
        <div className="bg-yellow-50 border-2 border-yellow-200 p-6 rounded-lg mb-8">
          <h3 className="text-lg font-semibold mb-2">🎯 Smart Navigation Enabled</h3>
          <p>
            This video features automatic key moment detection. Search engines can automatically
            identify and link to specific tips throughout the video based on the content.
          </p>
        </div>
        ...
        <section>
          ...
          <p>
            Join Chef Sarah Thompson for a rapid-fire session of 50 essential kitchen tips that will
            save you time, reduce waste, and improve your cooking. Each tip is explained in just 30
            seconds, making this the ultimate quick reference guide.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="bg-blue-50 p-6 rounded-lg">
            <p className="mb-4">
              This video uses <strong>SeekToAction</strong> structured data, which allows search
              engines to:
            </p>
            <ul>
        ...
        <section>
          ...
          <p>
            By presenting 50 tips in rapid succession, viewers can quickly find exactly what they
            need. The SeekToAction implementation means search engines can understand the content
            structure and help users jump directly to relevant tips.
          </p>
        </section>

        <div className="bg-green-50 p-6 rounded-lg">
          <p className="text-lg">
            <strong>Viewer Tip:</strong> Try searching for specific cooking problems in your search
            engine. If this video contains a relevant tip, you might see a direct link to that exact
            moment in the video!
          </p>
        </div>
      </main>
