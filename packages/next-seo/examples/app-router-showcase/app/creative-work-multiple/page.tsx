    ...
    <div className="container mx-auto p-8">
      ...
      <article className="prose lg:prose-xl">
        ...
        <div className="introduction bg-white p-6 rounded-lg shadow-md">
          <h2>Introduction</h2>
          <p>
            This article demonstrates how to mark multiple paywalled sections within a single piece
            of content. Each premium section is identified by a unique CSS selector.
          </p>
          <p>
            The free introduction gives readers an overview of what's covered in the premium
            sections below.
          </p>
        </div>
        ...
        <div className="section1 bg-blue-50 p-6 rounded-lg shadow-md mt-6 border-2 border-blue-300">
          ...
          <p>
            This first premium section contains detailed research findings that are available only
            to subscribers. The structured data identifies this section as paywalled using the CSS
            class "section1".
          </p>
          <p>
            Subscribers can access comprehensive data analysis, charts, and expert insights in this
            section.
          </p>
        </div>
        ...
        <div className="middle-content bg-white p-6 rounded-lg shadow-md mt-6">
          ...
          <p>
            This middle section is free content that bridges the two premium sections. It helps
            maintain reader engagement while clearly distinguishing between free and paid content
            areas.
          </p>
        </div>
        ...
        <div className="section2 bg-purple-50 p-6 rounded-lg shadow-md mt-6 border-2 border-purple-300">
          ...
          <p>
            The second premium section explores advanced applications and real-world case studies.
            This content is also behind the paywall, identified by the CSS class "section2".
          </p>
          <p>
            Premium subscribers gain access to exclusive case studies, implementation guides, and
            expert recommendations in this section.
          </p>
        </div>
        ...
        <div className="conclusion bg-white p-6 rounded-lg shadow-md mt-6">
          <h2>Conclusion</h2>
          <p>
            The free conclusion summarizes the key points and encourages readers to subscribe for
