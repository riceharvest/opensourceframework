    ...
    <div className="container mx-auto p-8">
      ...
      <article className="prose lg:prose-xl">
        ...
        <p>
          ...
          solutions. The successful candidate will be able to build high-quality, innovative and
        ...
        <ul>
          ...
          <li>Ability to develop software in Java, Ruby, C++ or other programming languages</li>
          <li>Excellent knowledge of relational databases, SQL and ORM technologies</li>
          <li>Experience developing web applications using at least one popular web framework</li>
