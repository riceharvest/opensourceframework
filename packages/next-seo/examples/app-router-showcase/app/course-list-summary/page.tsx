    ...
    <div className="container mx-auto p-8">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-lg text-gray-600 mb-8">
          Discover a wide range of technology courses designed to advance your career and expand
          your knowledge.
        </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <h2 className="text-xl font-semibold mb-2">Introduction to Programming</h2>
          ...
          <a
            ...
            className="block border rounded-lg p-6 hover:shadow-lg transition-shadow"
          >
            <h2 className="text-xl font-semibold mb-2">Web Development Bootcamp</h2>
          ...
          <a
            ...
            className="block border rounded-lg p-6 hover:shadow-lg transition-shadow"
          >
            <h2 className="text-xl font-semibold mb-2">Data Science Fundamentals</h2>
            <p className="text-gray-600 mb-4">Master data analysis and visualization techniques.</p>
            <span className="text-blue-600 hover:text-blue-800">Learn more →</span>
          </a>
          ...
          <a
            ...
            className="block border rounded-lg p-6 hover:shadow-lg transition-shadow"
          >
            <h2 className="text-xl font-semibold mb-2">Machine Learning & AI</h2>
            <p className="text-gray-600 mb-4">Explore artificial intelligence and ML algorithms.</p>
            <span className="text-blue-600 hover:text-blue-800">Learn more →</span>
          </a>
