        ...
        review={[
          {
            ...
            author: 'Fred Benson',
            reviewBody: 'This anvil is perfect! Exactly what I needed for my roadrunner traps.',
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm text-gray-600">4.4 (89 reviews)</span>
                </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold">Available from 5 sellers</h3>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mb-2">
                      <span className="text-2xl font-bold text-green-600">$119.99</span>
                    ...
                    <p className="text-sm text-gray-500 mt-2">Usually ships within 24 hours</p>
                  </div>
              ...
              <div className="border rounded-lg p-4 hover:shadow-lg transition-shadow">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 mt-2">Ships in 2-3 business days</p>
                  </div>
              ...
              <div className="border rounded-lg p-4 hover:shadow-lg transition-shadow">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 mt-2">Order by 2pm for next day delivery</p>
                  </div>
                  <button className="bg-gray-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-gray-700">
                    View Deal
                  </button>
              ...
              <div className="border rounded-lg p-4 hover:shadow-lg transition-shadow">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h4 className="font-semibold text-lg mb-1">Hardware Haven</h4>
                    <div className="flex items-center gap-4 mb-2">
                    ...
                    <p className="text-sm text-gray-500 mt-2">Ships in 3-5 business days</p>
                  </div>
                  <button className="bg-gray-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-gray-700">
                    View Deal
                  </button>
              ...
              <div className="border rounded-lg p-4 hover:shadow-lg transition-shadow">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h4 className="font-semibold text-lg mb-1">Premium Tools</h4>
                    <div className="flex items-center gap-4 mb-2">
            ...
            <div className="mt-8 bg-gray-50 rounded-lg p-6">
              ...
              <div className="h-48 bg-white rounded border flex items-center justify-center">
                <span className="text-gray-400">Price trend chart would go here</span>
              </div>
            ...
            <div className="mt-8">
                ...
                <div className="border rounded-lg p-4">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      ...
                      <span className="text-sm text-gray-600 ml-2">Jan 10, 2024</span>
                    </div>
                ...
                <div className="border rounded-lg p-4">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      ...
                      <span className="text-sm text-gray-600 ml-2">Jan 5, 2024</span>
                    </div>
                    <span className="flex text-yellow-400">★★★★☆</span>
                  </div>
                  <p className="text-gray-700">
              ...
              <button className="mt-4 text-blue-600 hover:underline">View all 89 reviews →</button>
            </div>
          </div>
        </div>
      </div>
