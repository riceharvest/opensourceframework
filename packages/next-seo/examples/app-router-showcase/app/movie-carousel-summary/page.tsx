  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <div className="prose lg:prose-xl">
        ...
        <p>
          This page demonstrates the summary page pattern for movie carousels, where each movie has
          its own detail page.
        </p>
        ...
        <ul>
          <li>
            <a href="https://example.com/movies/a-star-is-born">A Star Is Born</a>
          </li>
          <li>
            <a href="https://example.com/movies/bohemian-rhapsody">Bohemian Rhapsody</a>
          </li>
          <li>
        ...
        <p>
          In this pattern, each movie URL points to a separate page with full details about that
          movie.
        </p>
      </div>
    </div>
