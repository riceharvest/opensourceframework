        ...
        <div className="relative mb-8">
          ...
          <div className="relative p-8">
            <div className="flex items-center space-x-6 mb-6">
              ...
              <div>
                <h1 className="text-5xl font-bold mb-2">Dragon Quest Legends</h1>
                <p className="text-xl text-gray-600">The ultimate mobile RPG experience</p>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg p-8 mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-xl opacity-90">Join millions of players worldwide!</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg p-6">
              ...
              <p className="text-gray-700">
                Embark on a 50+ hour journey through a beautifully crafted fantasy world. Make
                choices that shape your destiny and uncover the secrets of the ancient dragons.
              </p>
            </div>
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-6">
              ...
              <p className="text-gray-700">
                Master our innovative real-time combat system with combo attacks, skill chains, and
                strategic positioning. No turn-based waiting!
              </p>
            </div>
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-lg p-6">
              ...
              <p className="text-gray-700">
                Team up with friends for epic raid battles, compete in PvP tournaments, or trade
                rare items in the global marketplace.
              </p>
            </div>
            <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-lg p-6">
              ...
              <p className="text-gray-700">
                Capture and train over 300 unique monsters, each with their own abilities and
                evolution paths. Build the ultimate team!
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center">
                  <span className="font-semibold text-lg">GamePro Magazine</span>
                  <span className="ml-2 text-yellow-400">★★★★★</span>
                </div>
                <span className="text-gray-500 text-sm">October 15, 2024</span>
              </div>
              <p className="text-gray-700">
                "A masterpiece of mobile gaming. Dragon Quest Legends sets a new standard for RPGs
                on mobile platforms."
              </p>
            </div>
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <p className="text-gray-700">
                "Amazing graphics and gameplay! The story is captivating, though the game requires a
        ...
        <section>
          <div className="bg-gradient-to-r from-purple-100 to-blue-100 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-700 mb-6">
              Join the Dragon Quest Legends community and start your epic journey today!
            </p>
