  ...
  return (
    <div className="container mx-auto p-8">
      <DatasetJsonLd
        ...
        sameAs={['https://doi.org/10.1000/182', 'https://data.gov/dataset/climate-2020-2024']}
        identifier={[
        ...
        distribution={[
          ...
          },
          {
            ...
            encodingFormat: 'JSON',
            contentSize: '3.1GB',
            description: 'Complete dataset in JSON format for programmatic access',
          },
          {
      ...
      <main className="max-w-6xl">
        <h1 className="text-4xl font-bold mb-6">Global Climate Data 2020-2024</h1>
        ...
        <section className="prose max-w-none mb-8">
          ...
          <p>
            Comprehensive climate measurements including temperature, precipitation, and atmospheric
            data collected from weather stations worldwide. This dataset provides hourly
            observations from over 10,000 weather stations globally, enabling detailed climate
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="border rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600 mb-3">2.5GB - Complete dataset</p>
            ...
            <div className="border rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600 mb-3">3.1GB - Programmatic access</p>
              <button className="w-full px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                Download JSON
              </button>
            </div>
            <div className="border rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600 mb-3">1.8GB - Scientific analysis</p>
              <button className="w-full px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                Download NetCDF
              </button>
            </div>
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-100 p-4 rounded">
            <p className="font-mono text-sm">
              Smith, J. et al. (2024) Global Climate Patterns 2020-2024. Nature Climate Change.
              https://doi.org/10.1038/s41558-024-01234
            </p>
          </div>
        </section>
