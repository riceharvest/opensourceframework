    ...
    <div className="container mx-auto p-8">
      <CarouselJsonLd
        ...
        items={[
          {
            name: 'The Matrix',
            image: ['https://example.com/matrix-poster.jpg', 'https://example.com/matrix-wide.jpg'],
            ...
            review: {
              ...
              reviewBody: 'A groundbreaking sci-fi masterpiece that redefined action cinema',
            },
          },
          {
            name: 'Inception',
      ...
      <div className="prose lg:prose-xl">
        <p>
          Discover the best sci-fi movies that have defined the genre and captivated audiences
          worldwide.
        </p>
