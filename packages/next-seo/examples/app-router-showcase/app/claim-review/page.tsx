  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <article className="prose lg:prose-xl">
        ...
        <p>
          We fact-checked the claim that "the world is flat" and found it to be demonstrably false
          based on overwhelming scientific evidence.
        </p>
        <h2>The Claim</h2>
        <p>
          Various online communities continue to promote the idea that Earth is flat rather than
          spherical, despite centuries of scientific evidence to the contrary.
        </p>
        <h2>The Facts</h2>
        ...
        <ul>
          ...
          <li>Different star constellations visible from different latitudes</li>
          <li>Time zones and the day/night cycle</li>
          <li>Gravity measurements across the globe</li>
        </ul>
        <h2>Our Verdict</h2>
        <p>
          The claim that Earth is flat is false. This has been conclusively proven through multiple
          lines of scientific evidence spanning centuries.
        </p>
      </article>
    </div>
  );
