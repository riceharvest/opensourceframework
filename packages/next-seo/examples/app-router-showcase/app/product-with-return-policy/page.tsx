    ...
    <div className="container mx-auto p-8">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <div className="flex items-center mb-4">
              <span className="text-2xl font-semibold text-green-600">$349.99</span>
              <span className="ml-4 text-sm text-gray-600">SKU: WH-1000XM5</span>
            </div>
            <div className="flex items-center mb-4">
            ...
            <p className="text-gray-700 mb-6">
              ...
              life. Experience premium sound quality with industry-leading noise cancellation
              technology.
            </p>
        ...
        <section className="mb-8 bg-gray-50 p-6 rounded-lg">
          <h2 className="text-2xl font-semibold mb-4">Extended 45-Day Return Policy</h2>
          ...
          <div className="mt-4 pt-4 border-t">
            <p className="text-sm text-gray-600">
              We accept returns for new items in original packaging or defective products. Download
              and print your return label from your account.
            </p>
          </div>
        </section>
        ...
        <section className="text-sm text-gray-600">
          <p>
            This example demonstrates a product with a specific return policy that may differ from
            the store's general return policy. The 45-day return window and free returns make this
            product especially attractive to customers.
          </p>
        </section>
      </div>
    </div>
