    ...
    <div className="container mx-auto p-8">
      ...
      <article className="prose lg:prose-xl">
        <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-6">
          ...
          <p className="text-lg">
            Summer Music Festival 2025 has been cancelled. All tickets will be refunded.
          </p>
        </div>

        <h2 className="text-2xl font-semibold mb-4">Summer Music Festival 2025</h2>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-gray-100 p-4 rounded opacity-60">
            <h3 className="text-xl font-semibold mb-2">Original Event Details</h3>
            <p>
          ...
          <div className="bg-gray-100 p-4 rounded">
            ...
            <p>All ticket holders will receive a full refund within 7-10 business days.</p>
            <p className="mt-2">
        ...
        <section className="mb-8">
          ...
          <p>
            We regret to inform you that the Summer Music Festival 2025 has been cancelled due to
            unforeseen circumstances. We apologize for any inconvenience this may cause and
            appreciate your understanding.
          </p>
          <p className="mt-4">
            All ticket purchases will be automatically refunded to the original payment method.
        ...
        <section>
          ...
          <p>
            Follow Austin Music Events for updates about future events and festivals. We look
            forward to bringing you amazing musical experiences in the future.
          </p>
        </section>
      </article>
    </div>
