      ...
      <article className="prose lg:prose-xl">
        <div className="bg-gray-100 border border-gray-300 rounded-lg p-6 text-center">
          ...
          <div className="text-sm text-gray-500 mb-4">
            ...
            <br />
            <span className="text-red-600">Deleted on January 10, 2024 at 3:00 PM</span>
          </div>
        ...
        <div className="mt-8 space-y-4">
          ...
          <p className="text-sm text-gray-600">
            Comments are preserved for context even though the original post has been deleted.
          </p>
          ...
          <div className="border-l-4 border-blue-400 pl-4 bg-blue-50 p-3 rounded">
            <p className="font-semibold">
              <a href="https://example.com/moderators" className="text-blue-600">
                Forum Moderators
              </a>
