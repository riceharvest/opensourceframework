# :sunrise: @opensourceframework/next-optimized-images [![npm version](https://badgen.net/npm/v/@opensourceframework/next-optimized-images)](https://www.npmjs.com/package/@opensourceframework/next-optimized-images) [![license](https://badgen.net/npm/license/@opensourceframework/next-optimized-images)](https://github.com/riceharvest/opensourceframework/blob/main/packages/next-optimized-images/LICENSE)
...
# or
yarn add @opensourceframework/next-optimized-images
# or
...
[MIT](https://github.com/riceharvest/opensourceframework/blob/main/packages/next-optimized-images/LICENSE) © OpenSource Framework Contributors; original work © Cyril Wanner
