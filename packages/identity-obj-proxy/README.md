# @opensourceframework/identity-obj-proxy [![Build Status](https://img.shields.io/travis/keyanzhang/@opensourceframework/identity-obj-proxy.svg?style=flat-square)](https://travis-ci.org/keyanzhang/@opensourceframework/identity-obj-proxy) [![npm version](https://img.shields.io/npm/v/@opensourceframework/identity-obj-proxy.svg?style=flat-square)](https://www.npmjs.com/package/@opensourceframework/identity-obj-proxy) [![test coverage](https://img.shields.io/coveralls/keyanzhang/@opensourceframework/identity-obj-proxy/master.svg?style=flat-square)](https://coveralls.io/github/keyanzhang/@opensourceframework/identity-obj-proxy?branch=master)
...
```
npm install @opensourceframework/identity-obj-proxy
```
...
## Example
``` javascript
import idObj from '@opensourceframework/identity-obj-proxy';
